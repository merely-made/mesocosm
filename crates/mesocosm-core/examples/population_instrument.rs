...
//! ```
//!
//! Writes `Code/testing/mesocosm/td9_chain.json` (curves + verdicts
...
/// Finds `Code/testing/mesocosm/td9_chain.json` by walking up from
...
fn receipt_path() -> PathBuf {
    ...
    workspace_root.join("testing/mesocosm/td9_chain.json")
}
