...
//! TD2d, TD5, TD5b, TD6, TD7, S1 and TD8 as each round's measuring stick.
//!
...
//! ```
//!
//! Writes `Code/testing/mesocosm/td8_chain.json` (curves + verdicts
...
/// Finds `Code/testing/mesocosm/td8_chain.json` by walking up from
...
fn receipt_path() -> PathBuf {
    ...
    workspace_root.join("testing/mesocosm/td8_chain.json")
}
