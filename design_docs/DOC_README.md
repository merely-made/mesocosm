...
| [2026-07-31_phenotype_plan.md](2026-07-31_phenotype_plan.md) | **Mesocosm body decisions and proof plan.** Unifies the special played body with scalar organisms without requiring every distant life form to stay voxel-realized; separates structural dependency from cyclic functional links, somatic growth from filial adaptation, and anatomy from vessel capability; keeps the trait array until a real replacement exists; puts burn-versus-incorporate first; derives adaptation income from local finite flows; and orders P0–P6 with explicit stop rules. |
| [2026-08-01_epoch_boundary_plan.md](2026-08-01_epoch_boundary_plan.md) | **Design plan, nothing built.** What happens *between* epochs. Speciation is an act rather than a threshold: the player forks and names, an unplayed lineage splits on a significant event, and the split *is* the reward. Shared-lineage adaptation uses immutable revisions and adopt-or-branch authorship: agreement shares a child continuation, disagreement preserves descent instead of merging edits. Significance is abnormality measured against the world's own record, judged retrospectively at the epoch boundary across seven axes, which gives the world a difficulty curve nobody authored and gives the storyteller a real brief: keep significance achievable by opening possibility. Selected goals are the aimable half and deliberately do not collapse into the retroactive half. Temperament is biographical, and plasticity is a life stage that youth pays for in capability. Records four things it needs that do not exist: an event log, a species tree, a world record, and a place graph. |
| [2026-08-01_processdef_plan.md](2026-08-01_processdef_plan.md) | **Mesocosm's extensible biology lane.** Defines `ProcessDef` as a namespaced transformation rather than a universal gene or ability flag; separates acquisition, developmental expression, embodied process allocation, channels, capability, and ecology; rules finite per-part allocation mosaics, direct and automatic arrangement through one validator, event-driven remodeling, phenotypic plasticity, and carry-body versus regrow-here crossing; puts one native played process before pack and Piccolo infrastructure; then specifies deterministic admission, commit-result authority, license gates, PD0-PD8 proofs, and the interleave with phenotype P3-P5. |
