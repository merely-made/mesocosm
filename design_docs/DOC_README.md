...
| [2026-08-01_processdef_plan.md](2026-08-01_processdef_plan.md) | **Mesocosm's extensible biology lane.** Defines `ProcessDef` as a namespaced transformation rather than a universal gene or ability flag; separates acquisition, developmental expression, embodied process allocation, channels, capability, and ecology; specifies a bounded Piccolo request/proposal ABI, deterministic pack and ruleset admission, commit-result authority, license gates, PD0-PD8 proofs, and the interleave with phenotype P3-P5. |
| [2026-07-31_wing_phenotype_contract_plan.md](2026-07-31_wing_phenotype_contract_plan.md) | **Wing-level body identity contract.** Separates subject, biological line, body revision, part address, structural anatomy, optional functional links, phenotype, projection, and chronicle; rules that primitive topology travels while every vessel derives its own capabilities; distinguishes the same individual from a descendant; specifies branch provenance, authority under concurrent facts, the body/chronicle v1 split, and W0-W6 proof gates. |
