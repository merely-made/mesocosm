...
## Local addendum — Mesocosm

Mesocosm is in early implementation. Docs are flat in `design_docs/`; no area
roots have been promoted yet.

Mesocosm is the named home for games-wing material under core §2: shared
architecture, the pipeline laws, and the shared vocabulary live once, in
[`2026-07-30_games_wing_founding.md`](2026-07-30_games_wing_founding.md).
Paredros and Isometry cite it by path. Do not copy it into other repos.
